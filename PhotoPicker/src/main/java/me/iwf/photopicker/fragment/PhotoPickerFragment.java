...
import static me.iwf.photopicker.PhotoPickerActivity.KEY_SELECTED_PHOTOS;
...
/*    public static PhotoPickerFragment NewInstance(int pageFlag){
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(pageFlag == PhotoPickerActivity.PHOTO){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        backBtn = (ImageView) rootView.findViewById(R.id.back_fragment);
...
//          Log.i("-->>","selected num = "+selectedItemCount);
//          int total = selectedItemCount + (isCheck ? -1 : 1);
//          if (total<0){
//            selectedNumTxt.setClickable(false);
//            selectedNumTxt.setVisibility(View.GONE);
//          }else {
//            selectedNumTxt.setClickable(true);
//            selectedNumTxt.setVisibility(View.VISIBLE);
//            selectedNumTxt.setText(total+"");
//          }
//
//          return true;
//        }
