...
public class ImagePagerFragment extends Fragment {
    ...
    private static CloseFragmentListener mListener;


    public static ImagePagerFragment newInstance(List<String> paths, int currentItem, CloseFragmentListener listener) {
    ...
    public static ImagePagerFragment newInstance(List<String> paths, int currentItem, int[] screenLocation, int thumbnailWidth, int thumbnailHeight, CloseFragmentListener mListener) {

        ImagePagerFragment f = newInstance(paths, currentItem, mListener);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new PhotoPagerAdapter(getActivity(), paths,mListener);
