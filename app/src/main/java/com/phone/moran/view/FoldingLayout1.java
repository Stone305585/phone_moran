...
public class FoldingLayout1 extends ViewGroup {
     ...
     * 当前viewgroup的状态。
     */
    private STATE state = STATE.NORMAL;//NORMAL;FOLDING;GONE;
    ...
    public FoldingLayout1(Context context) {
        super(context);
    }

    public FoldingLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FoldingLayout1(Context context, AttributeSet attrs, int defStyle) {
...
//        }
    ...
    */
    private void calculateMatrices() {
        ...
        SLogger.d("gg", "mFoldFactor--->" + mFoldFactor);
        SLogger.d("gg", "mPreviousFoldFactor--->" + mPreviousFoldFactor);
