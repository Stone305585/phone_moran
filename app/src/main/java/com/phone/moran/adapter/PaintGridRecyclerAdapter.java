 ...
 * 画单详情下面的recycler
 */
public class PaintGridRecyclerAdapter extends BaseRecyclerAdapter<Paint> {


    public PaintGridRecyclerAdapter(Context context, List<Paint> datas) {
        super(context, datas);
    }
    ...
    public void showViewHolder(BaseRecyclerHolder holder, final int position) {
        ...
        final Paint picture = mData.get(position);

        ImageLoader.displayImg(mContext, picture.getTitle_url(), mHolder.imageGrid);
